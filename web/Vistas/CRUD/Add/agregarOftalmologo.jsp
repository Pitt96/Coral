    ...
    <body>
        <section class="d-flex justify-content-center align-items-center mt-5">
            <div class="card  p-3 col-sm-6 p-3" >
                <div class="mb-3">
                    <h1 class="text-center">Agregar Oftalmologo</h1>
                 </div>
                ...
                <form action="ControladorOftalmologo" class="d-flex d-flex justify-content-around" >
                    <div class="container_inputs">
                       ...
                       <div class="mb-2">
                        ...
                        <div class="mb-2 mt-5">
                            <a class="btn btn-outline-secondary pe-5 ps-5"  href="ControladorOftalmologo?accion=listarOftalmologo" role="button">Cancelar</a>
                        </div>
