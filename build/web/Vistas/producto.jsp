            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="nav ms-auto text-dark flex-column flex-lg-row">
                        ...
                        <a href="ControladorDirecciones?accion=listarProductos" class="nav-link text-dark active">Productos</a>
       ...
       <main class="container_main">
        <div class="container mt-5">
            ...
            <div class="container_agregar mb-2">
                <a class="btn btn-success" href="ControladorProducto?accion=AgregarP" role="button"><span><i class="fa-sharp fa-solid fa-plus"></i></span>Agregar</a>
            </div>
            ...
            <table id="tabla_usuarios" class="table-sm-responsive table-striped display responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="tamaño_titulo_table">IMAGEN</th>
                        <th class="tamaño_titulo_table">NOMBRE</th>
                        <th class="tamaño_titulo_table">PRECIO</th>
                        <th class="tamaño_titulo_table">STOCK</th>
                        <th class="tamaño_titulo_table">CATEGORIA</th>
                ...
                %>
                    <tr>
                        <td class="tamaño"><%=  pro.getCodigo()%></td>
                        <td class="tamaño"><img src="https://drive.google.com/uc?export=download&id=<%= pro.getRuta()%>" width="100px" height="80px"></td>
                        <td class="tamaño"><%= pro.getNombre()%></td>
                        <td class="tamaño">$<%= pro.getPrecio()%></td>
                        <td class="tamaño"><%= pro.getStock()%></td>
                        <td class="tamaño"><%= pro.getCat().getNombre()%></td>
                        <td class="d-flex flex-column justify-content-center align-items-center">
                            <a class="pt-1 pb-1 ps-4 pe-4 mb-1 mt-1 bg-primary rounded-pill  text-decoration-none text-white fw-bold" href="ControladorProducto?accion=editar&id=<%= pro.getCodigo()%>">Editar</a>
                            <a class="pt-1 pb-1 ps-3 pe-3 mb-1 bg-danger rounded-pill text-decoration-none text-white fw-bold" href="ControladorProducto?accion=eliminar&id=<%= pro.getCodigo()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
